...
ggsave(plot = b_p, filename = "../Figure_5/prior_ring.tiff",dpi = 600, units = "in", height = 2.6, width=5.2 * 0.5, compression = "lzw")
...
ggsave(plot = beta_dens, filename = "../Figure_5/prior_beta.tiff",dpi = 600, units = "in", height = 2.6*0.5, width=5.2*0.5, compression = "lzw")
...
ggsave(plot = c_p, filename = "../Figure_5/prior_wc.tiff",dpi = 600, units = "in", height = 2.6*0.5, width=5.2*0.5, compression = "lzw")
