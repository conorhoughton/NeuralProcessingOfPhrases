...
ggsave(filename = "../Figure_4/elec_angle_participant.tiff", plot = main_p, width = 5.2*0.75, height = 1.5, units = "in", dpi=600, compression = "lzw")
...
ggsave(filename = "../Figure_4/elec_angle_dist.tiff", plot = sub_p, width = 5.2*0.25, height = 1.5, units = "in", dpi=600, compression = "lzw")
