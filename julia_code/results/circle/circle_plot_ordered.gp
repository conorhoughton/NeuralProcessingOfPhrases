...
set palette model RGB defined  (1 'red', 2 'red', 3 'red', 4 'red', 5 'red', 6 'red', 7 'red', 8'red', 9 'red', 10 'red', 11 'red', 12 'blue', 13 'green', 14 'green', 15 'green', 16 'blue', 17 'blue', 18 'green', 19 'green', 20 'green', 21 'green', 22 'blue', 23 'black', 24 'black', 25 'black', 26 'black', 27 'black', 28 'black', 29 'brown', 30 'brown', 31 'brown', 32 'black')

unset colorbox
unset key

plot "ordered_values.txt" us (($2)+($5)):4:(int($3)) with points palette
